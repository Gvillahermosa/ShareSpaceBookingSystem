    ...
    return (
        <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-8 py-4 sm:py-8">
            ...
            <div className="mb-4 sm:mb-6">
                <h1 className="text-xl sm:text-2xl md:text-3xl font-semibold mb-2">{property.title}</h1>
                <div className="flex flex-wrap items-center justify-between gap-2 sm:gap-4">
                    <div className="flex flex-wrap items-center gap-1 sm:space-x-2 text-xs sm:text-sm">
