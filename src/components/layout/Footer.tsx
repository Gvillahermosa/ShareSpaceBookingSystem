...
export default function Footer() {
    ...
    const footerLinks = {
        ...
        hosting: [
            { label: 'Try Hosting', href: '/become-host' },
            { label: 'Host Resources', href: '/become-host' },
            { label: 'Community Forum', href: '/become-host' },
            { label: 'Responsible Hosting', href: '/become-host' },
        ],
        sharespace: [
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
                        ...
                        <ul className="space-y-3">
                            {footerLinks.support.map((link) => (
                                <li key={link.href}>
                                    <Link
                                        to={link.href}
                                        className="text-sm text-secondary-600 hover:text-secondary-900 hover:underline"
                                    >
                                        {link.label}
                                    </Link>
                                </li>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            {footerLinks.sharespace.map((link) => (
                                <li key={link.href}>
                                    <Link
                                        to={link.href}
                                        className="text-sm text-secondary-600 hover:text-secondary-900 hover:underline"
